/**
 * Created by amies on 2017/11/23.
 */
'use strict';
...
var createInject = require('../src/injector');
describe('parse', function () {
    var parse;
    beforeEach(function () {
        publishExternalAPI();
        parse = createInject(['ng']).get('$parse');
    });
    ...
    it('parses assign any primary expression', function () {
    ...
    it('does not allow accessing window as nono-computed peoperty',function () {
       var fn = parse('anObject.wnd');
       expect(function () {
           fn({anObject: {wnd: window}});
       }).toThrow();
    ...
    it('parses additives on a higher precedence than relations', function () {
    ...
    it('can parse filter expressions', function () {
        var injector = createInject(['ng', function ($filterProvider) {
    ...
    it('can pass an additional argument to filters', function () {
        parse = createInject(['ng', function ($filterProvider) {
    ...
    it('allows calling assign an identifier expressions', function () {
