...
describe('$compile', function() {
    ...
    it('stops compiling at a terminal directive', function() {
        ...
        var injector = createInjector(['ng', 'myModule']);
        injector.invoke(function($compile) {
            var el = $('<div frst-directive second-directive></div>');
            $compile(el);
            expect(compilations).toEqual(['frst']);
        });
    });
    ...
    describe('attributes', function() {
        ...
        it('does not set attributes to DOM when ﬂag is false', function() {
            registerAndCompile(
                'myDirective',
                '<my-directive attr="true"></my-directive>',
                function(element, attrs) {
            ...
            describe('with transclusion', function() {
                ...
                it('works when template arrives after', function() {
                    ...
                    injector.invoke(function($compile, $rootScope) {
                        ...
                        var linkFunction = $compile(el);
                        $rootScope.$apply();
                        linkFunction($rootScope); // link frst
    ...
    describe('transclude', function() {
        ...
        describe('interpolation', function() {
            ...
            it('fres observers on attribute expression changes', function() {
            ...
            it('fres observers just once upon registration', function() {
                var observerSpy = jasmine.createSpy();
                var injector = makeInjectorWithDirectives({
                    myDirective: function() {
                        return {
