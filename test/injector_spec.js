...
describe('injector', function () {
   ...
   it('does not accept non-starings as injection token', function () {
       var module = window.angular.module('myModule', []);
       module.constant('a', 1);
       var injector = createInjector(['myModule']);
       var fn = function (one, two) {
   ...
   it('overrides dependencies with locals when invokeing', function () {
       var module = window.angular.module('myModule', []);
       module.constant('a', 1);
       module.constant('b', 2);
       var injector = createInjector(['myModule']);
    ...
    describe('annotate', function () {
        ...
        it('strips coments from argument lists when parsing', function () {
           var injector = createInjector([]);
        ...
        it('instantitates a dependency only once', function () {
           var module = window.angular.module('myModule', []);
        ...
        it('uses dependency injection with decorators', function () {
            ...
            module.constant('a',33);
            module.decorator('aValue', function (a,$delegate) {
                $delegate.decoratedKey = a;
            });
            var injector = createInjector(['myModule']);
            expect(injector.get('aValue').decoratedKey).toBe(33);
        });
    });
});